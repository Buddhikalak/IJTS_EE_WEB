 ...
 * @author Buddhika
 */
public class ScratchCard_Update extends javax.swing.JFrame {

    /**
     * Creates new form ScratchCard_Update
     */
    public ScratchCard_Update() {
        initComponents();
        setTitle("Update Scratch");
...
new  Scratch_update_details(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString(), jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString(), jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString(), jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString(), jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString(),jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString()).setVisible(true) ;    // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScratchCard_Update.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

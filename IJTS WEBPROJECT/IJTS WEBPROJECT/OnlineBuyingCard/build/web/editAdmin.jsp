    ...
    <head>
        ...
        int uid=0;
            try {
              ...
              uid=userid;
              ResultSet rs = db.Database.Database().executeQuery("SELECT user_type_id FROM user_pivilages WHERE page_id=(SELECT page_id FROM pages WHERE url ='editAdmin.jsp')");
                        ...
                        <div class="panel-body">
                          ...
                          <div class="row show-grid">
                              ...
                              <br/> <br/> <% } %>
                                 ...
                                 <button class="btn btn-outline btn-info"   type="submit" >Update Admin Details</button>
                                 <button type="button" onclick="ClickDashBoard()" class="btn btn-primary">Skip</button>
                              </form>

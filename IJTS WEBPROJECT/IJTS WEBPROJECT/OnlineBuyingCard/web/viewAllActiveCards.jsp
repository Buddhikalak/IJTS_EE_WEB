<%-- 
    Document   : viewAllActiveCards
    Created on : Jan 26, 2015, 10:08:18 PM
    Author     : Buddhika
viewAllActiveCards
--%>
<%-- 
    ...
    <head>
        ...
        <%
            ...
            try {
                ...
                File fichier = new File("C:\\images\\viewAllActiveCards.jrxml");
                ...
                response.setHeader("Content-disposition", "filename=cards.pdf");

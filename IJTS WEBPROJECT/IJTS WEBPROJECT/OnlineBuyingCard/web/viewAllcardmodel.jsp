<%-- 
    Document   : viewAllcardmodel
    Created on : Jan 26, 2015, 10:17:38 PM
    Author     : Buddhika
--%>
<%-- 
    ...
    <head>
        ...
        <%
            ...
            try {
                ...
                File fichier = new File("C:\\images\\cardmodel.jrxml");
                ...
                response.setHeader("Content-disposition", "filename=ViewAllCardModel.pdf");

<%-- 
    Document   : loginError
    Created on : Jan 27, 2015, 11:35:12 PM
    Author     : Buddhika
--%>
    ...
    <div class="sp-container">
        <div class="sp-content">
            <div class="sp-globe"></div>
            	<h2 class="frame-1">Please Wait</h2>

            	<h2 class="frame-2">You Are enter the error value</h2>

            	<h2 class="frame-3">You can Try again</h2>

            	<h2 class="frame-4">Now!</h2>

            	<h2 class="frame-5"><span>Insert the Correct</span> <span>Email &</span> <span>Password.</span></h2>
	<a class="sp-circle-link" href="singin.jsp">Sing in!</a>
